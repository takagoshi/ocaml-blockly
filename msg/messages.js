...
Blockly.Msg.PROCEDURES_HUE = '#eebbcb';
...
Blockly.Msg.LISTS_MAP2_TOOLTIP = 'map f al bl applies f to each element of al bl and returns the resulting list. If the two lists differ in length, raise the exception Invalid_argument.'
...
Blockly.Msg.READ_IMAGE_TOOLTIP = 'Read an image of the given size';
Blockly.Msg.IMAGE_WIDTH_TOOLTIP = 'Return the width of an image';
Blockly.Msg.IMAGE_HEIGHT_TOOLTIP = 'Return the height of an image';
...
Blockly.Msg.SUM_TOOLTIP = 'Return the sum of integers in the given list';
